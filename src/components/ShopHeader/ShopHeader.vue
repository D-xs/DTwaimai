<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="showShop = true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="showSupport = true">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showShop">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="showShop = false">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="showSupport">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="showSupport = false">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      supportClasses: ['activity-green', 'activity-red', 'activity-orange'], //用来定义样式数组
      showShop: false,  // 控制商家详情是否显示
      showSupport: false, //控制优惠活动详情是否显示
    }
  },
  computed: {
    ...mapState('shop',['info'])
